...
python3 qromp_enc_ips.py test-in-orig/smb1e.nes       test-in-orig/smb1e.nes              test-out/smb1e-nop.ips
...
python3 qromp_ips.py test-in-orig/smb1e.nes       test-out/smb1e-nop.ips          test-out/smb1e-nop.nes
